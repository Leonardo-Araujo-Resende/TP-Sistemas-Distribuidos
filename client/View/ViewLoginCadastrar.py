    ...
    def __init__(self, window, controller_log_cad: ControllerLoginCadastrar):
        ...
        def on_click(event):
            ...
            if retorno == 1:
                ...
                self.window.username = self.get_input_usuario()
        ...
        #Mensagens
        self.mensagem_usuario = UILabel( text="", x=self.width/2 - 400/2, y=50, width=400, height=30, font_name="Roboto", align="center",font_size=14,text_color=self.window.cor_escura)
